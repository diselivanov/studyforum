...
import { getViewTopicRoute, getViewUserRoute } from '../../lib/routes'
    ...
    <div id={topic.id} className={`${css.Topic} ${className}`}>
      <div className={css.content}>
        ...
        <div className={css.meta}>
          {topic.discipline && <span className={css.disciplineBadge}>{topic.discipline}</span>}
          {topic.teacher && <span className={css.teacherBadge}>{topic.teacher}</span>}
        </div>
      </div>
      ...
      <div className={css.info}>
        <div className={css.author}>
          ...
          <Link className={css.authorInfo} to={getViewUserRoute({ selectedUser: topic.author.id })}>
